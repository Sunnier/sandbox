...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const data = [
    ...
    [
      309,
      "Nunc dapibus aliquet nisl sed accumsan. Nunc eget eros metus maecenas.",
    ],
    ...
    [
      109,
      "Nullam sed erat varius sem tincidunt faucibus et vitae tortor. In hac habitasse platea dictumst.",
    ],
